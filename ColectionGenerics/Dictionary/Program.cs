...
Console.WriteLine("-Incluir elemento com chave(3) duplicada");
try
{
    dic3.Add(3, 333);
}
...
if (dic3.TryGetValue(7, out int valor1))
{
    Console.WriteLine("Valor para a chave 7 = " + valor1);
}
else
{
    Console.WriteLine("Chave não encontrada");
...
var dic3Ordenado = dic3.OrderBy(x => x.Key); //linq
